...
if __name__ == '__main__':
    ...
    rospy.init_node('human_gym', anonymous=True, log_level=rospy.INFO)
    ...
    env = wrappers.Monitor(env, outdir, force=True)  # TODO
