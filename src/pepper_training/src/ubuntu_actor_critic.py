...
if __name__ == '__main__':
  ...
  joint_increment_values = [0.2]  # TODO joint_increment_value=0.1moyarinasou
  for joint_increment_value in joint_increment_values:
    env = gym.make('Pepper-v1', joint_increment_value=joint_increment_value)  # TODO
